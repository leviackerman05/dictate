...
Windows setup keeps the Smart App Control limitation visible outside collapsed details. Linux is no longer offered or auto-selected; unsupported browsers see both supported choices.
